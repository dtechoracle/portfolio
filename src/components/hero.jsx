        ...
        <div className="flex flex-col items-start flex-1 md:flex md:flex-row md:gap-10 md:items-center lg:flex lg:flex-row lg:items-center lg:gap-x-12 lg:justify-between">
          <div>
            <div className="gradientText">
              ...
              >
                Creative Fullstack developer<span>.</span>
              </h1>
            </div>
            <p className="gradientText font-medium font-pop text-[15px] text-[#FFFFFF99] max-w-[353px] mt-[45px] md:mt-8 lg:mt-1 md:max-w-[639px] md:text-[18px] leading-md:[27px]">
              I craft and create solid and scalable frontend products with great
              user experiences.
            </p>
            <div
              id="intro"
            ...
            >
              <p className="max-w-[310px]">
                4+ Years of experience. Specialized in building products, while
                ensuring a seamless web and mobile experience for clients across africa and
                overseas.
              </p>
            ...
            <div className="mt-[35px] md:mt-[65px] flex justify-start items-center  gap-[26px] md:gap-[40px]">
              ...
              <motion.a
                href="https://twitter.com/dtechoracle"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
              ...
              <motion.a
                href="https://www.instagram.com/dtechoracle"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
              ...
              <motion.a
                href="https://www.linkedin.com/in/Ezekiel-Jeremiah"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
