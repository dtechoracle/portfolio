    ...
    <section className="mx-[30px] mt-[60px] lg:mx-[76px] lg:mt-[150px]">
      <div className="flex flex-col items-center gap-[35px] md:gap-[25px]">
        ...
        <p className="flex items-center font-semibold text-[15px] leading-[22.5px] md:text-[20px] md:leading-[30px] text-[#FFFFFF99]">
          GBEWA <small className={`animate-bounce`}>👋</small>
        </p>
      </div>
      <div
      ...
      >
        <div className="flex flex-col items-center gap-[10px]">
          <div className="pr-[1px] pt-[1px] max-w-[75px] max-h-[75px]">
            <MailIcon
          ...
          <a
            ...
            href="mailto:iamezekieljeremiah@gmail.com"
          >
            iamezekieljeremiah@gmail.com
          </a>
        </div>
        <div className="flex flex-col items-center gap-[10px]">
          <div className="pr-[1px] pt-[1px] max-w-[75px] max-h-[50px]">
            <PhoneIcon
              className={`w-[30px] h-[30px] p-2 md:p-[5px] bg-[#061417] md:w-[36px] md:h-[36px]`}
            />
          </div>
          <a
            href="tel:+2348127982163"
        ...
        <div className="flex flex-col items-center gap-[10px]">
          ...
          >
            ...
            {timeOfDay === "evening" && <span>Your Heart</span>}
